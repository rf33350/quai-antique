 ...
 */
final class Version20230505185645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, restaurant_id INT DEFAULT NULL, date DATE NOT NULL, arrival_hour TIME NOT NULL, seats INT NOT NULL, service VARCHAR(255) NOT NULL, allergy VARCHAR(255) NOT NULL, INDEX IDX_42C84955B1E7706E (restaurant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
